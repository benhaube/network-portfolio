...
| :symbols-server-nas:&nbsp;NAS Server                | Living-Room | [<code>ZimaOS-NAS</code>](../02_Hardware/ZimaBoard_2_NAS.md)      | `00:E0:4C:5B:9A:96` | :symbols-ethernet-port-outline: | :symbols-check: | Main file storage server *(eth0)*                                    |
| :symbols-server-nas:&nbsp;NAS Server                | Living-Room | [<code>ZimaOS-NAS</code>](../02_Hardware/ZimaBoard_2_NAS.md)      | `00:E0:4C:5B:9A:95` | :symbols-ethernet-port-outline: | :symbols-check: | Second NIC for main file storage server *(eth1)*                     |
...
| :symbols-chromecast:&nbsp;Streaming Stick           | Living-Room | `StreamingStick4K`                                                | `50:06:F5:53:2A:F2` |         :symbols-wifi:          | :symbols-check: | Roku Streaming Stick 4K (2025), Connected to TV in Living Room       |
...
| Device Type                                     | Location    | Hostname                                                                | MAC Address         |   Interface    |   WAN Access    | Role / Notes                                                    |
| :---------------------------------------------- | :---------- | :---------------------------------------------------------------------- | :------------------ | :------------: | :-------------: | :-------------------------------------------------------------- |
| :symbols-home-automation:&nbsp;IoT Server       | Office      | [<code>home-assistant</code>](../02_Hardware/Raspberry_Pi_4B_Server.md) | `E4:5F:01:A4:60:08` | :symbols-wifi: | :symbols-check: | Home Assistant server, hosted on `pi-server` via `wlan0`        |
...
| :symbols-nest-thermostat:&nbsp;Thermostat       | Living-Room | `nest-thermostat`                                                       | `18:B4:30:1D:4F:05` | :symbols-wifi: | :symbols-check: | Nest Thermostat for HVAC system                                 |
...
| :symbols-lightstrip-outline:&nbsp;LED Strip     | Office      | `office-desk-accent`                                                    | `D4:AD:FC:0E:F1:B1` | :symbols-wifi: |   :symbols-x:   | Govee RGB LED strip for desk accent lighting                    |
