...
![IT-Tools homepage](../assets/screenshots/it-tools-home-light.png#only-light){ width=400 align=right }
![IT-Tools homepage](../assets/screenshots/it-tools-home-dark.png#only-dark){ width=400 align=right }
