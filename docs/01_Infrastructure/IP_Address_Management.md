...
| :----- | :----------- | :---------------- | :---------------------------- | :------- | :--------------: | :------------------------------------------- |
| VLAN50 | *Home*       | `192.168.50.0/24` | `192.168.50.6` `192.168.50.2` | internal | :material-check: | :material-security:&nbsp;Trusted VLAN        |
| VLAN52 | *Home_Guest* | `192.168.52.0/24` | `9.9.9.9` `149.112.112.112`   | -        | :material-check: | :symbols-shield-person-fill:&nbsp;Guest VLAN |
| VLAN53 | *2G_IoT*     | `192.168.53.0/24` | `9.9.9.9` `149.122.122.122`   | -        | :material-close: | :symbols-shield-house-fill:&nbsp;IoT VLAN    |
...
| [:material-router-wireless:&nbsp;ASUS RT-AX55](../02_Hardware/ASUS_RT-AX55.md)             | VLAN50 | `192.168.50.221` | `RT-AX55-1360`  | Reserved | AiMesh Node *(Backhaul)*                                                                                                  |
...
| [:material-raspberry-pi:&nbsp;Ras-Pi 4B Server](../02_Hardware/Raspberry_Pi_4B_Server.md) *(wlan0)* | VLAN53 | `DHCP`           | `pi-server`        | DHCP, Bridge to VLAN53 for [Home Assistant](../03_Services/Home_Assistant.md) |
