...
|  *Active*  | [:services-netalertx:&nbsp;NetAlertX](../03_services/netalertx.md)                      |    `20211` `20212`     | Centralized network visibility and continuous asset discovery. Monitor devices, detect change, and stay aware across distributed networks.          |
