...
+ **Immutable Documentation:** Maintaining a "Single Source of Truth" using **Markdown** with [VSCodium](https://vscodium.com/) and [Material for MkDocs](https://squidfunk.github.io/mkdocs-material/) to ensure the infrastructure is reproducible and transparent.
