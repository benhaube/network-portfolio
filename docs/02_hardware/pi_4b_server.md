...
|   Status   | Service                                                                           | Port(s) {data-sort-method='number'} | Role / Notes {data-sort-method='none'}                                                                                                         |
| :--------: | :-------------------------------------------------------------------------------- | :---------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------- |
|  *Active*  | [:services-beszel:&nbsp;Beszel Hub](../03_services/beszel.md)                     |          `8090`<br>`45876`          | A lightweight server monitoring hub with historical data, docker stats, and alerts.                                                            |
...
| *Inactive* | [:services-portainer:&nbsp;Portainer-EE](../03_services/portainer.md)             |     `8000`<br>`9000`<br>`9443`      | A lightweight service delivery platform for containerized applications.                                                                        |
