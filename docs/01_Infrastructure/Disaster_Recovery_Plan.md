...
+ Linux PCs, [<code>bens-workstation</code>](../02_Hardware/Bens_Desktop.md) and [<code>ben-laptop</code>](../02_Hardware/Bens_Laptop.md), have the `/home` directory backed up to the [ZimaOS NAS](../02_Hardware/ZimaBoard_2_NAS.md) every weekday at 18:00 and 19:00 UTC-5 using a custom script, `home-bkp-nas.sh`, that utilizes [NFS](../03_Services/NFS.md) and `rsync`. 
