...
| :----- | :----------- | :---------------- | :------------- | :---------------------------------------------------------------------------------- | :------- | :--------------------: | :-------------------------------------- |
| VLAN50 | *Home*       | `192.168.50.0/24` | `192.168.50.1` | `192.168.50.6` `192.168.50.2` *\[[Technitium](../03_Services/Technitium.md) (DoT)]* | internal |    :material-check:    | :material-security:&nbsp;Trusted        |
| VLAN52 | *Home_Guest* | `192.168.52.0/24` | `192.168.52.1` | `9.9.9.9` `149.112.112.112` *\[[Quad-9](https://quad9.net) (DoT)]*                  | -        |    :material-check:    | :symbols-shield-person-fill:&nbsp;Guest |
| VLAN53 | *2G_IoT*     | `192.168.53.0/24` | `192.168.53.1` | `9.9.9.9` `149.122.122.122` *\[[Quad-9](https://quad9.net) (DoT)]*                  | -        |    :material-close:    | :symbols-shield-house-fill:&nbsp;IoT    |
...
| :material-raspberry-pi:&nbsp;[Raspberry Pi 4B Server](../02_Hardware/Raspberry_Pi_4B_Server.md) *(eth0)* | VLAN50 | `192.168.50.2`   | `pi-server.internal`        | Static   | DNS Secondary *([Technitium](../03_Services/Technitium.md) cluster)*, [CUPS](../03_Services/CUPS_Print_Server.md)         |
...
| :material-debian:&nbsp;[Debian Server VM](../02_Hardware/Debian_Server_VM.md)                            | VLAN50 | `192.168.50.6`   | `debian-vm.internal`        | Reserved | DNS Primary *([Technitium](../03_Services/Technitium.md) cluster)*, VM on [ZimaOS NAS](../02_Hardware/ZimaBoard_2_NAS.md) |
