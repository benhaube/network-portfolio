...
# Last updated on 2026-01-15 10:35:37 EST
...
[dns]
  ...
  piholePTR = "HOSTNAMEFQDN" ### CHANGED, default = "PI.HOLE"
  ...
  hosts = [
    "192.168.50.2 pi-server",
    "192.168.50.3 pi-hole",
    "192.168.50.1 asusrouter",
    "192.168.50.153 k1c-a71e",
    "192.168.50.61 bens-workstation",
    "192.168.50.4 storage-server",
    "192.168.50.5 storage-server-2",
    "192.168.50.6 debian-vm"
  ] ### CHANGED, default = []
  ...
  hostRecord = "pi-server,pi-server.local,192.168.50.2" ### CHANGED, default = ""
  ...
  #     Example: "fritz.box"
  revServers = [
    "true,192.168.50.0/24,192.168.50.1,internal"
  ] ### CHANGED, default = []
  ...
  [dns.domain]
    ...
    # Allowed values are:
    #     Any valid domain
    name = "internal" ### CHANGED, default = "lan"
  ...
  [dns.specialDomains]
    ...
    [dns.reply.host]
      ...
      IPv4 = "192.168.50.2" ### CHANGED, default = ""
      ...
      IPv6 = "fd88:246b:c431::53" ### CHANGED, default = ""
  ...
  [dns.rateLimit]
    ...
    # Allowed values are:
    #     A positive integer value
    count = 2000 ### CHANGED, default = 1000
...
[dhcp]
  ...
  # Allowed values are:
  #     A valid IPv4 address, or empty string ("")
  start = "192.168.50.4" ### CHANGED, default = ""
  ...
  # Allowed values are:
  #     A valid IPv4 address, or empty string ("")
  end = "192.168.50.254" ### CHANGED, default = ""
  ...
  # Allowed values are:
  #     A valid IPv4 address, or empty string ("")
  router = "192.168.50.1" ### CHANGED, default = ""
  ...
  # Allowed values are:
  #     true or false
  ipv6 = true ### CHANGED, default = false
  ...
  hosts = [
    "FC:EE:28:09:A7:1E, 192.168.50.153, K1C-A71E, infinite",
    "2c:cf:67:db:f5:e2, 192.168.50.3, pi-hole, infinite"
  ] ### CHANGED, default = []
  ...
  [ntp.ipv4]
    ...
    address = "192.168.50.2" ### CHANGED, default = ""
  ...
  [ntp.ipv6]
    ...
    address = "fd88:246b:c431::53" ### CHANGED, default = ""
  ...
  [ntp.sync]
    ...
    server = "asusrouter.internal" ### CHANGED, default = "pool.ntp.org"
    ...
    [ntp.sync.rtc]
      ...
      # Allowed values are:
      #     true or false
      set = true ### CHANGED, default = false
...
[database]
  ...
  maxDBdays = 14 ### CHANGED, default = 91
...
[webserver]
  ...
  # Allowed values are:
  #     A valid domain
  domain = "pi.hole1" ### CHANGED, default = "pi.hole"
  ...
  ] ### CHANGED, default = [ "X-DNS-Prefetch-Control: off", "Content-Security-Policy: default-src 'self'; style-src 'self' 'unsafe-inline'; img-src 'self' data:;", "X-Frame-Options: DENY", "X-XSS-Protection: 0", "X-Content-Type-Options: nosniff", "Referrer-Policy: strict-origin-when-cross-origin" ]
  ...
  # Allowed values are:
  #     true or false
  serve_all = true ### CHANGED, default = false
  ...
  [webserver.interface]
    ...
    #   - "lcars"
    #       Star Trek LCARS
    theme = "default-darker" ### CHANGED, default = "default-auto"
  ...
  [webserver.api]
    ...
    pwhash = "$BALLOON-SHA256$v=1$s=1024,t=32$OEuKamidO4p5LFVT6vC01Q==$FATjwicODLE2m5v9TxKQVVx+9fIPA2Rq/FIy4e7wiGQ=" ### CHANGED, default = ""
    ...
    # Allowed values are:
    #     A valid Pi-hole password hash
    app_pwhash = "$BALLOON-SHA256$v=1$s=1024,t=32$wWqYZx72iKKXYwlWS7VQtA==$x198dWeI+uwrYbRzKRA8vQ1M+ajne+JL2W8AThtQM9c=" ### CHANGED, default = ""
...
# 162 total entries out of which 124 entries are default
# --> 38 entries are modified
```
