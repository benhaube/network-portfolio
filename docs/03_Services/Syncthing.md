...
* **Port(s):** `8384`
* **URL / Access:** 
    * :simple-fedora:&nbsp;[[Ben's_Desktop|Ben's Desktop]]:
        * <http://bens-workstation.internal:8384>
        * <http://192.168.50.61:8384>
    * :simple-fedora:&nbsp;[[Ben's_Laptop|Ben's Laptop]]:
        * <http://127.0.0.1:8384>
...
x-casaos:
  ...
  description:
    ...
    el_GR: >
      # Απελευθερώνοντας το πραγματικό δυναμικό της δημιουργίας αντιγράφων
      ασφαλείας δεδομένων
