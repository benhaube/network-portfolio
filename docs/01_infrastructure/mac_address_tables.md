...
| :------------------------------------------ | :---------- | :-------------------------------------------------------------- | :------------------ | :---------------------: | :-------------: | :------------------------------------------------------------------- |
| :symbols-server-dns:&nbsp;DNS Server        | Office      | [<code>pi-server</code>](../02_hardware/pi_zero_2w_server.md)   | `E4:5F:01:A4:60:07` | :symbols-ethernet-port: | :symbols-check: | Secondary [Technitium](../03_services/technitium.md) DNS server node |
...
| :symbols-server-dns:&nbsp;DNS Server        | -           | [<code>debian-vm</code>](../02_hardware/debian_server.md)       | `52:54:00:28:BB:EA` | :symbols-ethernet-port: | :symbols-check: | Primary [Technitium](../03_services/technitium.md) DNS server node   |
...
| :lucide-laptop-minimal:&nbsp;Laptop PC     | Mobile      | [<code>ben-laptop</code>](../02_hardware/bens_laptop.md)        | `A6:97:E3:D2:F1:C4` |     :symbols-wifi:      | :symbols-check: | Ben's laptop PC                                                      |
...
| :lucide-laptop-minimal:&nbsp;Laptop PC     | Mobile      | [<code>ems1</code>](../02_hardware/robs_laptop.md)              | `E8:9C:25:90:8B:11` | :symbols-ethernet-port: | :symbols-check: | Ethernet NIC on Rob's main laptop PC                                 |
| :lucide-laptop-minimal:&nbsp;Laptop PC     | Mobile      | [<code>ems1</code>](../02_hardware/robs_laptop.md)              | `F8:54:F6:C1:88:D2` |     :symbols-wifi:      | :symbols-check: | Wi-Fi NIC on Rob's main laptop PC                                    |
