...
| :-------------------------------------------------- | :---------- | :---------------------------------------------------------------- | :------------------ | :-----------------------------: | :-------------: | :------------------------------------------------------------------- |
| :symbols-dns:&nbsp;DNS Server                       | Office      | [<code>pi-server</code>](../02_Hardware/Raspberry_Pi_Zero_2_W.md) | `E4:5F:01:A4:60:07` | :symbols-ethernet-port-outline: | :symbols-check: | Secondary [Technitium](../03_Services/Technitium.md) DNS server node |
...
| :symbols-dns:&nbsp;DNS Server                       | -           | [<code>debian-vm</code>](../02_Hardware/Debian_Server_VM.md)      | `52:54:00:28:BB:EA` | :symbols-ethernet-port-outline: | :symbols-check: | Primary [Technitium](../03_Services/Technitium.md) DNS server node   |
