!!! config "Critical Configurations"
    ...
    **:symbols-clock-refresh-cw:&ensp;Chrony:**
    ...
    + Time synchronizes with local time server running on main router, [ASUS RT-BE92U](../docs/includes/asus_rt-be92u.md), using `chrony`.
    + See the ["Clients"](../docs/03_services/chrony.md#clients) section of the Chrony service documentation page for configuration information. 
    ...
    **:symbols-lock-keyhole-open:&ensp;LUKS Unlocking:**
    ...
    + More information about the configuration process can be found at: [Unlocking LUKS Volumes with TPM2](../docs/linux_tutorials/unlock_luks_tpm2.md) 