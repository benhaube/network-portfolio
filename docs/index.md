...
![Material Design file-document-multiple customized icon](assets/icons/file-document-multiple-color.svg){ width=200 }&emsp;![Material Design format-list-bulleted customized icon](assets/icons/format-list-bulleted.svg){ width=50 } 
