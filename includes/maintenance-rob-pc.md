...
+ File backup is handled with Window's built-in backup tool. Files in the user's directory are sent to the [ZimaOS NAS](../02_hardware/zimaos_nas.md#data){ data-preview } via [SMB](../03_services/smb.md).
