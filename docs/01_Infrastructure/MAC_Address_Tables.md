...
| :material-nas:&nbsp;NAS Server *(eth0)*        | Living-Room | [<code>ZimaOS-NAS</code>](../02_Hardware/ZimaBoard_2_NAS.md)      | `00:E0:4C:5B:9A:96` | :material-ethernet: | :material-check: | Main file storage server *(eth0)*                                    |
| :material-nas:&nbsp;NAS Server *(eth1)*        | Living-Room | [<code>ZimaOS-NAS</code>](../02_Hardware/ZimaBoard_2_NAS.md)      | `00:E0:4C:5B:9A:95` | :material-ethernet: | :material-check: | Second NIC for main file storage server *(eth1)*                     |
...
| :devices-nest-audio:&nbsp;Nest Speaker         | Office      | `nest-audio`                                                      | `1C:53:F9:FA:F6:7C` |   :material-wifi:   | :material-check: | Nest Audio in Office                                                 |
...
| :devices-chromecast-fill:&nbsp;Streaming Stick | Living-Room | `StreamingStick4K`                                                | `50:06:F5:53:2A:F2` |   :material-wifi:   | :material-check: | Roku Streaming Stick 4K (2025), Connected to TV in Living Room       |
...
| Device Type                                       | Location    | Hostname                                                                | MAC Address         |    Interface    |    WAN Access    | Role / Notes                                                    |
| :------------------------------------------------ | :---------- | :---------------------------------------------------------------------- | :------------------ | :-------------: | :--------------: | :-------------------------------------------------------------- |
| :material-home-assistant:&nbsp;Home Assistant     | Office      | [<code>home-assistant</code>](../02_Hardware/Raspberry_Pi_4B_Server.md) | `E4:5F:01:A4:60:08` | :material-wifi: | :material-check: | Home Assistant server, hosted on `pi-server` via `wlan0`        |
