...
| :symbols-nas:&nbsp;NAS Server                       | Living-Room | [<code>ZimaOS-NAS</code>](../02_Hardware/ZimaBoard_2_NAS.md)      | `00:E0:4C:5B:9A:96` | :symbols-ethernet-port-outline: | :symbols-check: | Main file storage server *(eth0)*                                    |
| :symbols-nas:&nbsp;NAS Server                       | Living-Room | [<code>ZimaOS-NAS</code>](../02_Hardware/ZimaBoard_2_NAS.md)      | `00:E0:4C:5B:9A:95` | :symbols-ethernet-port-outline: | :symbols-check: | Second NIC for main file storage server *(eth1)*                     |
