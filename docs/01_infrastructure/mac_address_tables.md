...
| :-------------------------------------- | :----------------------------------- | :------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------- |
| :symbols-globe:&nbsp;Cable Modem        | Living Room&emsp;                    | [`N/A`](../02_hardware/hitron_modem.md#network-configuration)              | :symbols-ethernet-port:&nbsp;_LAN 1_                                                                                                             | `00:1c:73:00:00:99`                                                                      |
| :symbols-router:&nbsp;Wireless Router   | Living Room&emsp;                    | [`RT-BE92U-FAF0`](../02_hardware/asus_rt-be92u.md#physical-ethernet-ports) | :symbols-ethernet-port:&nbsp;_WAN_<br>:symbols-wifi-lock:&nbsp;_2.4 GHz_<br>:symbols-wifi-lock:&nbsp;_5 GHz_<br>:symbols-wifi-lock:&nbsp;_6 GHz_ | `60:CF:84:51:FA:F0`<br>`6A:CF:84:51:FA:F1`<br>`82:CF:84:51:FA:F5`<br>`60:CF:84:51:FA:F9` |
| :symbols-router:&nbsp;Mesh Node         | Office                               | [`RT-AX55-1360`](../02_hardware/asus_rt-ax55.md#physical-ethernet-ports)   | :symbols-ethernet-port:&nbsp;_WAN_<br>:symbols-wifi-lock:&nbsp;_2.4 GHz_<br>:symbols-wifi-lock:&nbsp;_5 GHz_                                     | `7C:10:C9:DF:13:60`<br>`7C:10:C9:DF:13:61`<br>`7C:10:C9:DF:13:64`                        |
...
| :------------------------------------------ | :---------- | :------------------------------------------------------------------------- | :------------------ | :-----------------------------------: | :------------------------------------------------------------------------------------------------------ |
| :symbols-server:&nbsp;DNS Server            | Office      | [`pi-server`](../02_hardware/pi_zero_2w_server.md#network-configuration)   | `E4:5F:01:A4:60:07` |        :symbols-ethernet-port:        | Secondary [Technitium](../03_services/technitium.md#deployment-details){ data-preview } DNS server node |
| :symbols-server:&nbsp;Proxy Server          | Office      | [`pi-zero`](../02_hardware/pi_zero_2w_server.md#network-configuration)     | `2C:CF:67:DB:F5:E2` |            :symbols-wifi:             | [Caddy](../03_services/caddy.md) reverse proxy server                                                   |
| :symbols-server-nas:&nbsp;NAS Server        | Living Room | [`ZimaOS-NAS`](../02_hardware/zimaos_nas.md#network-configuration)         | `00:E0:4C:5B:9A:96` |        :symbols-ethernet-port:        | Main file storage server _(eth0)_                                                                       |
| :symbols-server-nas:&nbsp;NAS Server        | Living Room | [`ZimaOS-NAS`](../02_hardware/zimaos_nas.md#network-configuration)         | `00:E0:4C:5B:9A:95` |        :symbols-ethernet-port:        | Second NIC for main file storage server _(eth1)_                                                        |
| :symbols-server:&nbsp;DNS Server            | -           | [`debian-vm`](../02_hardware/debian_server.md#network-configuration)       | `52:54:00:28:BB:EA` |        :symbols-ethernet-port:        | Primary [Technitium](../03_services/technitium.md#deployment-details){ data-preview } DNS server node   |
| :symbols-pc-case:&nbsp;Desktop PC           | Office      | [`bens-workstation`](../02_hardware/bens_desktop.md#network-configuration) | `3C:7C:3F:0D:A9:CD` |        :symbols-ethernet-port:        | Ben's Main desktop PC                                                                                   |
| :symbols-pc-case:&nbsp;Desktop PC           | Office      | [`bens-workstation`](../02_hardware/bens_desktop.md#network-configuration) | `C2:57:52:3B:6F:D8` |            :symbols-wifi:             | Wi-Fi NIC on Ben's main desktop PC                                                                      |
| :symbols-laptop-minimal:&nbsp;Laptop PC     | Mobile      | [`ben-laptop`](../02_hardware/bens_laptop.md#network-configuration)        | `A6:97:E3:D2:F1:C4` |            :symbols-wifi:             | Ben's laptop PC                                                                                         |
| :symbols-printer-3d-nozzle:&nbsp;3D-Printer | Office      | [`k1c-a71e`](../02_hardware/kacey_3d-printer.md#network-configuration)     | `FC:EE:28:09:A7:1E` |            :symbols-wifi:             | Creality K1C 3D-printer                                                                                 |
| :symbols-pc-case:&nbsp;Desktop PC           | Office      | [`Rob-Desktop`](../02_hardware/robs_desktop.md#network-configuration)      | `50:EB:F6:59:74:C3` |        :symbols-ethernet-port:        | Rob's main desktop PC                                                                                   |
| :symbols-pc-case:&nbsp;Desktop PC           | Office      | [`Rob-Desktop`](../02_hardware/robs_desktop.md#network-configuration)      | `70:A6:CC:B5:F5:4A` |            :symbols-wifi:             | Wi-Fi NIC on Rob's main desktop PC                                                                      |
| :symbols-laptop-minimal:&nbsp;Laptop PC     | Mobile      | [`ems1`](../02_hardware/robs_laptop.md#network-configuration)              | `E8:9C:25:90:8B:11` |        :symbols-ethernet-port:        | Ethernet NIC on Rob's main laptop PC                                                                    |
| :symbols-laptop-minimal:&nbsp;Laptop PC     | Mobile      | [`ems1`](../02_hardware/robs_laptop.md#network-configuration)              | `F8:54:F6:C1:88:D2` |            :symbols-wifi:             | Wi-Fi NIC on Rob's main laptop PC                                                                       |
| :symbols-smartphone:&nbsp;Pixel 9 Pro       | Mobile      | [`ben-s-phone`](../02_hardware/bens_smartphone.md#network-configuration)   | `08:8B:C8:4E:19:7B` |            :symbols-wifi:             | Ben's phone, Google Pixel 9 Pro                                                                         |
| :symbols-smartphone:&nbsp;Galaxy S25+       | Mobile      | [`robert-s-s25`](../02_hardware/robs_phone.md#network-configuration)       | `1A:5C:54:48:81:37` |            :symbols-wifi:             | Rob's phone, Samsung Galaxy S25+                                                                        |
...
| :symbols-watch-square:&nbsp;Smartwatch      | Mobile      | `google-pixel-watch-2`                                                     | `16:EA:08:E8:93:75` |            :symbols-wifi:             | Ben's Smartwatch, Google Pixel Watch 2                                                                  |
| :symbols-watch-square:&nbsp;Smartwatch      | Mobile      | `sm-l325u`                                                                 | `F6:C4:21:D8:26:45` |            :symbols-wifi:             | Rob's Smartwatch, Samsung Galaxy Watch 8                                                                |
...
| Device Type                               | Location        | Hostname                                                                 | MAC Address             | Interface { data-sort-method="none" } | Role / Notes { data-sort-method="none" }                                |
| :---------------------------------------- | :-------------- | :----------------------------------------------------------------------- | :---------------------- | :-----------------------------------: | :---------------------------------------------------------------------- |
| :symbols-house-wifi:&nbsp;IoT Server      | Office          | [`home-assistant`](../02_hardware/pi_4b_server.md#network-configuration) | `E4:5F:01:A4:60:08`     |            :symbols-wifi:             | Home Assistant server, hosted on `pi-server` via `wlan0`                |
| :symbols-robot-vacuum:&nbsp;Robot Vacuum  | Living Room     | `roomba-675`                                                             | `80:C5:F2:DC:B1:57`     |            :symbols-wifi:             | Roomba 675 robot vacuum                                                 |
| :symbols-house-shield:&nbsp;Alarm Hub     | Living Room     | `ring-solutions`                                                         | `B0:09:DA:1C:92:08`     |            :symbols-wifi:             | Ring Alarm base station                                                 |
...
| :symbols-sun-snow:&nbsp;Thermostat        | Living Room     | `ONELITE_CT`                                                             | `10:51:DB:D3:81:C2`     |            :symbols-wifi:             | Thermostat for Goodman inverter heat pump HVAC system                   |
...
| :symbols-led-on:&nbsp;LED Strip           | Kitchen         | `govee-H617A-2267`                                                       | `D2:30:38:36:22:67`     |          :symbols-bluetooth:          | Govee H617A LED strip, connected to Home Assistant server via Bluetooth |
