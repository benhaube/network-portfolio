...
|  _Active_  | [:services-it-tools:&nbsp;IT-Tools](../03_services/it-tools.md)                   |           `8000`<br>`8080`            | Collection of handy online tools for developers, with great UX.                                                                                                                                                                     |
|  _Active_  | [:brands-matter:&nbsp;Matter Server](../03_services/matter_server.md)             |                `5580`                 | The **Open Home Foundation** Matter Server serves as the foundation to provide Matter support to [Home Assistant](../03_services/home_assistant.md), but its universal approach makes it suitable to be used in other projects too. |
