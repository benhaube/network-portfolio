???+ note
    ...
    :    You can download a Nerd Font from the official [Nerd Fonts:symbols-external-link-small:](https://www.nerdfonts.com/) website. I prefer `NotoMono NerdFont` and `JetBrainsMono NerdFont`. Once you install a Nerd Font on your system, you can set the font in your terminal application to render the Starship and Fastfetch symbols.   