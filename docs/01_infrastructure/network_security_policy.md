...
| [:symbols-shield-user:&nbsp;Guest](ip_address_management.md#virtual-local-networks) | _VLAN52_&emsp;&emsp; | Temporary visitor devices                              | Internet access only; strictly isolated from all other VLANs                                                                                          |
| [:symbols-shield-house:&nbsp;IoT](mac_address_tables.md#iot-network)                | _VLAN53_&emsp;&emsp; | Smart home hardware _(bulbs, sensors, etc.)_           | **No Internet Access** by default. Strictly isolated from all other VLANs; communication only with [Home Assistant](../03_services/home_assistant.md) |
