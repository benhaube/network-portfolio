...
![Material Design file-document-multiple customized icon](assets/icons/logo.svg){ width=200 }&emsp;![Material Design format-list-bulleted customized icon](assets/icons/format-list-bulleted.svg){ width=50 } 
