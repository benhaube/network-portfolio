...
[Manual&ensp;:symbols-notebook-text:](../assets/manuals/TL-SG105.pdf){ .md-button .md-button--primary }&emsp;[Datasheet&ensp;:symbols-quick-reference-outline:](../assets/manuals/TL-SG105_info.pdf){ .md-button .md-button--primary }
