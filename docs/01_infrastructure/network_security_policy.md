...
| :--------------------------------------------------------------------------------- | :------------------- | :----------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------- |
| [:symbols-shield:&nbsp;Trusted](mac_address_tables.md#trusted-network)             | *VLAN50*&emsp;&emsp; | Primary workstations, mobile devices, and core servers | Full access to all internal zones; restricted outbound                                                                                                |
| [:symbols-user-shield:&nbsp;Guest](ip_address_mangement.md#virtual-local-networks) | *VLAN52*&emsp;&emsp; | Temporary visitor devices                              | Internet access only; strictly isolated from all other VLANs                                                                                          |
| [:symbols-house-shield:&nbsp;IoT](mac_address_tables.md#iot-network)               | *VLAN53*&emsp;&emsp; | Smart home hardware *(bulbs, sensors, etc.)*           | **No Internet Access** by default. Strictly isolated from all other VLANs; communication only with [Home Assistant](../03_services/home_assistant.md) |
