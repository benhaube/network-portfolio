...
| :--- | :------ | :---------- | :----------- |
| Trusted | *vlan50* | Primary workstations, mobile devices, and core servers | Full access to all internal zones; restricted outbound |
| Guest | *vlan52* | Temporary visitor devices | Internet access only; strictly isolated from all other VLANs |
| IoT | *vlan53* | Smart home hardware *(bulbs, sensors, etc.)* | **No Internet Access** by default; communication only with [Home Assistant](../03_Services/Home_Assistant.md) |
